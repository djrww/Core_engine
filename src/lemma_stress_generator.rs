...
impl LemmaStressEvaluator {
    ...
    pub fn run_massive_evaluation(seed: u64, scale_factor: usize) -> LemmaStressReport {
        ...
        let l6_target = 500 * scale_factor;
        ...
        let l10_kb_target = 200 * scale_factor;
        let chordal_target = 500 * scale_factor;
        let l12_monad_target = 500 * scale_factor;
        let ddmin_target = 200 * scale_factor;
        let l14_polonius_target = 500 * scale_factor;
        let l15_mir_target = 500 * scale_factor;
        let l16_reborrow_target = 500 * scale_factor;
        let l17_aeneas_target = 500 * scale_factor;
        let l18_diff_share_target = 500 * scale_factor;
        ...
        for _ in 0..l10_kb_target {
            ...
            let cert = CPFCertificate::new_knuth_bendix("CL0-KB", "PolynomialOrder", 10);
            if cert.to_cpf_xml().contains("<crKnuthBendix>") {
