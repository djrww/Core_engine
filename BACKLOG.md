...
| DL-003 | 覆蓋率門檻上調 65 → 72(圖鑑 D-4;依賴 DL-001 完成後方可執行) | 品質基建 | done | S | ci.yml --fail-under-lines 72;CI 全綠 | ci.yml 門檻 65→72;本地 lib 覆蓋 75.7% > 72;CI 綠後補 run id |
...
| 1 | 2026-09-05 | DL-001、DL-002、DL-003(3 完成 ≥ 3 開工) | 本輪 |
